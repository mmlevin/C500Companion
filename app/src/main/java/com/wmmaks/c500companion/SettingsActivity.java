...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || PowerAMPPreferenceFragment.class.getName().equals(fragmentName)
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class PowerAMPPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_poweramp);
            setHasOptionsMenu(true);
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class BacklightPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
